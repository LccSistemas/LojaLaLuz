      ...
      <div class="container mx-auto px-4 py-8 lg:py-12">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
          ...
          <div class="space-y-4">
            <!-- Main Image -->
            <div
              class="aspect-[3/4] bg-cream-50 overflow-hidden relative group"
            >
              @if (product()!.onSale) {
              <div
                class="absolute top-4 left-4 z-10 bg-black text-white text-xs px-3 py-1.5 tracking-wider"
              >
                -{{ calculateDiscount() }}%
              </div>
              }
          ...
          <div class="lg:sticky lg:top-24 lg:self-start">
            ...
            <!-- Name -->
            <h1
              class="font-cormorant text-3xl md:text-4xl font-light text-black mb-4"
            >
              {{ product()!.name }}
            </h1>
            ...
            <div class="mb-6">
              <h3 class="text-xs uppercase tracking-wider mb-4">
                Cor:
                <span class="font-medium">{{ selectedColor()?.color }}</span>
              </h3>
            ...
            <div class="mb-8">
              <div class="flex items-center justify-between mb-4">
                ...
                <button
                  class="text-xs underline text-gray-500 hover:text-black transition-colors"
                >
                  Guia de Tamanhos
                </button>
              </div>
...
export class ProductDetailComponent implements OnInit {
  ...
  canAddToCart(): boolean {
    ...
    return (
      !!variant && variant.available && variant.stockQuantity >= this.quantity()
    );
  }
  ...
  addToCart(): void {
    ...
    this.cartService
      .addItem(product.id, this.quantity(), variant.id)
      .subscribe({
        next: () => {
